...
sequenceDiagram
    ...
    game ->> dis: MT_QUERY_SPACE_GAMEID_FOR_MIGRATE/spaceID,eid/查询spaceId是否可迁移
    ...
    game ->> dis: MT_MIGRATE_REQUEST/eid,spaceId,spaceGameId
